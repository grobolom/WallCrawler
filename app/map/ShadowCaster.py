...
class ShadowCaster:
    ...
    def castShadow(self, col, center, sector, squares, results, octant):
        ...
        for x in range(col, len(squares)):
            last_square = ''
            ...
            # important because this is what stops our main sector loop from
            # continuing if we hit a wall. For example, try this:
            #
            # ...
            # ..+
            # @#
            #
            # if you don't include this, the + square gets colored
            if last_square == '#':
                break
